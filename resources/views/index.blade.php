	...
	<div class="container">
		<div class="row justify-content-center ">
			<div class="col-lg-5 col-md-6 my-auto isi order-1 text-center text-lg-start">
				...
				<button id="copyip" class="btn btn-costum1" value="https://instagram.com/raffidev">Contact Me</button>

				<div class="social-icon">
					{{-- <p>Media Sosial</p>
					<a href="https://facebook.com/raffidev"><img src="../../img/svg/facebook.svg"></a>
					<a href="https://instagram.com/raffidev"><img src="../../img/svg/instagram.svg"></a>
					<a href="https://www.youtube.com/c/raffidev"><img src="../../img/svg/youtube.svg"></a>
					<a href="https://wa.me/6285157868689"><img src="../../img/svg/whatsapp.svg"></a> --}}
				</div>
			</div>
