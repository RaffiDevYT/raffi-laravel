...
@if ($posts->count())
    <div class="card mb-3 bg-white" style="transform: scale(0.9)">
        @if ($posts[0]->image)
      ...
      <div class="card-body text-center">
        ...
        <p>
            ...
            by <a href="/posts?author={{ $posts[0]->author ?? null }}">{{ $posts[0]->author ?? null }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}">{{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}
            </small>
        </p>
        ...
        <div class="col-md-4 mb-1">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <small class="text-muted">
                        by <a href="/posts?author={{ $post->author ?? null }}">{{ $post->author ?? null }}</a> {{ $post->created_at->diffForHumans() }}
                        </small>
                    </p>
